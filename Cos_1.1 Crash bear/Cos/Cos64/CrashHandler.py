...
message = "\nA fatal error has occured in the currently running prosess that caused a kernal panic\n" \
          "This screen has occured to protect your system for further damage caused by the crashed program\n" \
